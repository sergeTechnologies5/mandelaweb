...
$query = "INSERT INTO transations (amount,group_id,user_id,phonenumber) values('$AMOUNT', '$user_id', '$user_id', '$NUMBER')";
try{
...
<html>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		...
		header('location:../dashboard/admin.php?message='.$message.'');	
