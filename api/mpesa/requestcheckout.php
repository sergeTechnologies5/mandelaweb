...
$query = "INSERT INTO `transations` (`id`, `amount`, `group_id`, `user_id`, `phonenumber`, `date_created`, `date_modified`) VALUES (NULL, '$AMOUNT', '$group_id', '$user_id', '$NUMBER', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
